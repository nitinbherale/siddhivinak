												...
												<tbody>
													 <?php include("connect.php");
                                                            ...
                                                            if (isset($_POST['delete'])) {
                                                                ...
                                                                $del_query = "DELETE FROM recent_event WHERE id = '$id' ";
                                                     ...
                                                     $select_qry = "SELECT * FROM recent_event";
												   ...
												   <tr>
													  ...
													  <td> <?php echo $row['evnt_duration']; ?></td>
													  <td> <?php echo $row['evnt_address']; ?></td>
													  <td> <?php echo $row['evnt_description']; ?></td>

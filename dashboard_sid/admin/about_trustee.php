				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-dark">About Trustee</h5>
						</div>
						...
						<?php
                          if (isset($_POST['add'])) {
	                       ...
	                       $insert_query = "update about_trustee set description = '$description', edit_date = now() where id = 1 ";
	                           $run_query = mysqli_query($dblink,$insert_query);
	                         if ($run_query) {
	                         	echo '<script> success_message("Updated","success","Updated Successfully","about_trustee.php"); </script>';
	                         }
	                         else{
	                         	 echo '<script> my_function("Error in Update"); </script>';
	                         }
                          }
                          list($content) = exc_qry("select * from about_trustee");
                        ?>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li class="active"><span>About Trustee</span></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">About Trustee</h6>
									</div>

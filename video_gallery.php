 ...
 <section id="project-version-one">
        <div class="container">
            ...
            <div class="row nor4al-gallery" id="image-gallery-mix">
                 <?php list($video) = exc_qry("select * from video_gallery where status = 0 order by id desc"); 
                        for ($i=0; $i < count($video); $i++) { ?>
                <div class="col-lg-4 col-sm-6 col-xs-12 <?php echo $video[$i]['cat_id']; ?> mix" style="display: inline-block;">
                    <div class="img-wrap">
                        <a href="<?php echo $video[$i]['link']; ?>" target="_blank" >
                        	<iframe src="<?php echo $video[$i]['link']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
						</a>
                    </div>
                </div>
            <?php } ?>
